...
<link rel="stylesheet" href="ProfessionalHomePage.css">
</head>
<style>
th {
	text-align: center;
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
					...
					<li class="nav-item"><a class="nav-link active" id="navbar2"
						aria-current="page" href="AllBookings.jsp">Home</a></li>
					<li class="nav-item"><a class="nav-link active" id="navbar2"
	...
	<center>
		...
		<div class="container mt-5">
			<div class="table-responsive">
				...
				<table
					class="table w-100 table table-hover table-bordered border responsive"
					align="center">
					<thead>
						<tr>
