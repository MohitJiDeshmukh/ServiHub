...
<body>
	...
	<nav id="navbar12" class="navbar navbar-expand-lg navbar-light"
		...
		<div class="container-fluid ">
			<label id="logo1">Servi<span id="logo2"> HUB</span></label>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0"
					...
					<li class="nav-item"><a class="nav-link active" id="navbar2"
						aria-current="page"
						href="/ServiHub/AllUser/AllUserAuditDetails.jsp">EDIT</a></li>
					<li class="nav-item"><a class="nav-link active" id="navbar2"
						aria-current="page" href="/ServiHub/AllUser/AllUserComplain.jsp">COMPLAIN</a></li>

				</ul>
				<button class="btn me-5"
					style="font-size: 40px; position: relative; background-image: url('https://png.pngtree.com/png-vector/20231019/ourmid/pngtree-user-profile-avatar-png-image_10211467.png'); background-size: cover; width: 70px; height: 60px;"
				...
				<div class="offcanvas offcanvas-end" tabindex="-1"
					...
					<div class="offcanvas-header">
						<h3 id="offcanvasRightLabel">MY PROFILE</h3>
					...
					<div class="offcanvas-body">
						<div class="container mt-4"
							...
							<div class="container  shadow-lg" id="pro"
								style="margin-top: 20px;">
								<div class="logo" style="margin-top: 50px;">
									<img
										src="https://png.pngtree.com/png-vector/20231019/ourmid/pngtree-user-profile-avatar-png-image_10211467.png"
										width="40%" height="100px" style="margin-left: 80px;" alt="">
									<input type="file">
				...
				<form action="/ServiHub/logout" method="post" class="d-flex">

					<!-- <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search"> -->
					<button type="submit" class="btn btn-warning me-5"
						style="border-radius: 13px; font-weight: bold;">
						<a class="nav-link dropdown-toggle text-dark ms-2 " role="button"
	...
	<div class="container mt-5" id="con1">
		...
		<div class="row">
			<div class="col">
				<img
					src="https://joboyindia.s3.amazonaws.com/jobservice/Electrician-Service-Near-Me-300300.png"
					alt="">
			</div>
			<div class="col">
				<img
					src="https://joboyindia.s3.amazonaws.com/jobservice/plumber2.jpg"
					alt="">
			</div>
			<div class="col">
				<img
					src="https://joboyindia.s3.amazonaws.com/jobservice/plumbing.png"
					alt="">
			</div>
			<div class="col">
				<img
					src="https://joboyindia.s3.amazonaws.com/jobservice/Home-cleaning-service-near-me.jpg"
					alt="">
			</div>
		</div>
	</div>
