...
*/
/* 
    Created on : 01-Nov-2023, 12:46:42 pm
    Author     : hp
*/
...
<body>
	<div class="container">
		<div class="cover">
			<div class="front">
				<img src="/ServiHub/assets/images/plumber2.jpg" alt="">
			</div>
		</div>
		...
		<div class="forms">
			<div class="form-content">
				<div class="login-form">
					...
					<form action="/ServiHub/LoginServlet" method="post">
						<div class="input-boxes">
							...
							<div class="text">
								<a href="/ServiHub/AllUser/AllUserAuditDetails.jsp">Forgot
									password?</a>
							</div>
							...
							<div class="text sign-up-text">
								Don't have an account? <a href="Register.jsp"><label>Sigup
										now</label></a>
							</div>
						</div>
					</form>
