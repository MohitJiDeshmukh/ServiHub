...
#dname, #demail, #dmobile, #daddress, #dcity, #dpassword, #dcpassword,
	#dfname {
	margin-left: 150px;
	font-weight: 700;
	color: red;
...
<body>
	<div class="wrapper">
		<form onsubmit="return validateForm()" action="/ServiHub/abc" method="post">
			<h2>Registration</h2>
			<div class="input-field">
				<input onkeyup="validateName()" id="name" type="text" name="name">
				<label>Enter your Name</label> <label id="dname"> </label>
			</div>

			<div class="input-field">
				<input onkeyup="validateEmail()" id="email" type="text" name="email">
				<label>Enter your email</label> <label id="demail"> </label>
			</div>
			<div class="input-field">
				<input id="address" type="text" name="address"> <label>Address</label>
				<label id="daddress"> </label>
			</div>

			<div class="input-field">
				
					<select name="userType" class="input-field" aria-label="Default select example">
					...
					<div class="input-field">
						<input onkeyup="validateMobile()" id="mobile" type="text"
							minlength="10" maxlength="10" name="contact"> <label>Mobile</label>
						<label id="dmobile"> </label>
					</div>
					<div class="input-field">
						<input onkeyup="validatePassword()" id="password" type="password"
							minlength="6" name="pass"> <label>Enter your
							password</label> <label id="dpassword"> </label>
					</div>
					<div class="input-field">
						<input onkeyup="validateCPassword()" id="cpassword"
							type="password" name="cpass"> <label>Confirm
							password</label> <label id="dcpassword"> </label>
					</div>

					<input onclick="validateForm()" id="button" type="submit"
					name="submit" value="Register">
					<div class="register">
						<p>
							You already have an account? <a href="LoginUser.jsp">Login</a>
						</p>
					</div>
		</form>
	</div>
