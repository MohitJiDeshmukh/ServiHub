...
<title>Plumber_Booking_Page</title>
...
<body>
	...
	<div id="con1" class="container">
		<div class="row row-cols-lg-1 row-cols-1 shadow-lg">
			<div class="col">
				<h3 style="font-weight: bold; margin-top: 20px; margin-left: 15px;">PLUMBER</h3>
					...
					<div id="collapseThree" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							<p style="margin-top: 15px;">After you book the service,
								plumbers in your area will receive a notification coordinated by
								Joboy customer service. Kindly wait for the confirmation
								message. Our service partner will call and note the details of
								the problem, to bring along the necessary tools and other
								equipment. Make sure all materials for service are kept ready
								before service starts. In case you want the Joboy partner to
								purchase the materials, let them know beforehand. The time taken
								for purchase of materials will be added as part of service
								charges. Joboy partner will give you a quotation if required for
								work that requires more than 4 hours. Work will be done only
								after your approval of the quote When the work is over, our
								agent will let you know the service charge. Please make the
								payment accordingly online on our platform or by cash to the
								service provider</p>
						</div>
					</div>
				</div>
				...
				<div class="accordion-item border border-white">
					...
					<div id="collapseThree" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							...
							<strong>Water problems are not unusual in our daily
								lives. Leaking taps in the washroom, slow draining kitchen
								sinks, and clogged toilets are everyday household issues in
								Electronic City. Though all of this is common, it’s not easy
								to find plumbers around Indira Nagar at the required time. Here,
								Joboy offers quickly accessible solutions to all water problems
								in residential areas such as Sarjapur Road. </strong>

							<p style="margin-top: 20px;">Plumbers in and around
								Whitefield have joined us to deliver quick services to water
								issues. Joboy has enabled residents in Bengaluru to avail
								themselves of the services according to their convenience. We
								have upto seven days warranty for all the plumbing services that
								our partners provide across Bangalore. Joboy plumbers will be on
								time to deliver services in Koramangala, K R Puram, Whitefield,
								and other major residential areas. Efficient plumbing services
								are available with affordable inspection charges at J P Nagar.
								Dripping faucets, broken fittings, or low water pressure in your
								house, will no longer delay your schedules. Contact Joboy for
								instant assistance.</p>
						</div>
					</div>
				</div>
			</div>
