...
<title>Carpenter_Booking_Page</title>
...
<body>
	...
	<div id="con1" class="container">
		<div class="row row-cols-lg-1 row-cols-1 shadow-lg">
			<div class="col">
				<h3 style="font-weight: bold; margin-top: 20px; margin-left: 15px;">CARPENTER</h3>
					...
					<div id="collapseThree" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							...
							<p style="margin-top: 20px;">From replacing a fuse to
								...
								Provider for expert electrical services in Bengaluru. Are
								electrical problems disrupting your routine? The circuit breaker
								could trip, or some tube lights may flicker. The insulation on
								wires may have worn off, or there could be rusting of the
								electric panels. Outdated wiring and faulty circuits are
								hazardous. However, finding an electrician at peak hours in
								bangalore is difficult. Not anymore, Joboy has it covered. Joboy
								connects you to safe electrical servicing even at odd times.

								Experienced electricians around your area have partnered with
								Joboy to deliver timely electrical services at affordable rates.
								Prioritizing your safety, we offer services at late hours in and
								around Bengaluru. The electricians in Electronic City and
								Sarjapur are taken after background verification by a third
								party. Joboy gives seven days warranty for the electrical
								repairs in Indiranagar and other areas. The service providers
								are also available in the key areas of Whitefield and M G Road.
								The service team partnered with Joboy provides on-demand service
								as per your convenience in Koramangala. Connect with us in
								Bangalore and get efficient services at the best rates.</p>
						</div>
					</div>
				</div>
			</div>
