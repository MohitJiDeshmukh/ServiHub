...
<title>Water_Purifier_Booking_Page</title>
...
<body>
	...
	<div id="con1" class="container">
		<div class="row row-cols-lg-1 row-cols-1 shadow-lg">
			<div class="col">
				<h3 style="font-weight: bold; margin-top: 20px; margin-left: 15px;">WATER
					PURIFIER</h3>
			...
			<div class="accordion " id="accordionExample">
				...
				<div class="accordion-item border border-white">
					...
					<div id="collapseTwo" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							...
							<p style="margin-top: 15px;">Home Service Provider charges
								for unit of 1 hour of service initially, and every 30 minutes
								thereon Material charges are additional. Customer can either
								purchase the material directly or request the service partner to
								procure it. Time for material procurement will be charged in the
								final bill If the user decides not to proceed with the service
								delivery or reschedules the service after partner arrives at the
								user premises, Rs. 150 will be charged as inspection charges An
								additional Rs. 150 will be added to the service charges for
								service delivery between 08:00 PM and 08:00 AM, on Sundays and
								public holidays. Our service partner will help you with a
								quotation in case of long hour work schedules. Please confirm
								the quotation before initiating work to avoid any conflict on
								service completion. In case you do not want to continue service,
								we may charge Rs. 150 as inspection charge. We offer upto 7 days
								warranty on the service in case of recurring issues of the same
								nature where repair was done</p>
				...
				<div class="accordion-item border border-white">
					...
					<div id="collapseThree" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							<p style="margin-top: 15px;">After you book the service,
								electricians in your area will receive a notification
								coordinated by Joboy customer service. Kindly wait for the
								confirmation message. Our service partner will call and note the
								details of the problem, to bring along the necessary tools and
								other equipment. Make sure all materials for service are kept
								ready before service starts. In case you want the Home Service
								provider partner to purchase the materials, let them know
								beforehand. The time taken for purchase of materials will be
								added as part of service charges. Joboy partner will give you a
								quotation if required for work that requires more than 4 hours.
								Work will be done only after your approval of the quote</p>
						</div>
					</div>
				</div>
				<br>
				<div class="accordion-item border border-white">
					...
					<div id="collapseThree" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							...
							<strong>How do you find the best electricians near you
								in Bengaluru, when you urgently need electrical repairs?</strong>

							<p style="margin-top: 20px;">From replacing a fuse to
								changing the wiring, we have it all. Connect with Joboy for
								expert electrical services in Bengaluru. Are electrical problems
								disrupting your routine? The circuit breaker could trip, or some
								tube lights may flicker. The insulation on wires may have worn
								off, or there could be rusting of the electric panels. Outdated
								wiring and faulty circuits are hazardous. However, finding an
								electrician at peak hours in bangalore is difficult. Not
								anymore, Joboy has it covered. Joboy connects you to safe
								electrical servicing even at odd times. Experienced electricians
								around your area have partnered with Joboy to deliver timely
								electrical services at affordable rates. Prioritizing your
								safety, we offer services at late hours in and around Bengaluru.
								The electricians in Electronic City and Sarjapur are taken after
								background verification by a third party. Joboy gives seven days
								warranty for the electrical repairs in Indiranagar and other
								areas. The service providers are also available in the key areas
								of Whitefield and M G Road. The service team partnered with
								Joboy provides on-demand service as per your convenience in
								Koramangala. Connect with us in Bangalore and get efficient
								services at the best rates.</p>
						</div>
					</div>
				</div>
			</div>
