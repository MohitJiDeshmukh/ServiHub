...
<title>Painter_Booking_Page</title>
...
<body>
	...
	<div id="con1" class="container">
		<div class="row row-cols-lg-1 row-cols-1 shadow-lg">
			<div class="col">
				<h3 style="font-weight: bold; margin-top: 20px; margin-left: 15px;">PAINTER</h3>
					...
					<div id="collapseThree" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							<p style="margin-top: 15px;">After you book the service,
								Painter in your area will receive a notification coordinated by
								...
								before service starts. In case you want the Home Service
				...
				<div class="accordion-item border border-white">
					...
					<div id="collapseThree" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							...
							<strong>Are you looking for trustworthy painting
								services in Indore? Home Service is the best provider of
								painters offering all types of painting services at the best
								price.</strong>

							<p style="margin-top: 20px;">Painting your house is often a
								challenging task. The thought of choosing the right painters,
								removing furniture and cleaning up afterward can be difficult to
								fit in our busy lifestyle. Joboy makes your job easier with its
								professional home solutions. We help you to connect with expert
								painting contractors, who offer hassle-free service.</p>
						</div>
					</div>
				</div>
			</div>
